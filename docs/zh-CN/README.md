...
![PSX 多列 Agent 工作台](../../tests/PSX.Web.Tests/visual-baselines/windows-chromium/split-agents--light.png)
...
公开发布包包含 .NET、Portable Node、Claude seed，以及 Kimi/Qwen/OpenCode 的受控基线；但**不包含** `claude.exe` 或用户安装在 `runtime/` 下的运行环境。
