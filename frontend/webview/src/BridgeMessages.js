...
export const BridgeSendType = Object.freeze({
    ...
    AppSettingsCommand: 'app_settings_command',
...
export const BridgeEventType = Object.freeze({
    ...
    DshRuntimeStatus: 'dsh_runtime_status',
    AppSettingsSnapshot: 'app_settings_snapshot',
    KimiWebRuntimeStatus: 'kimi_web_runtime_status',
