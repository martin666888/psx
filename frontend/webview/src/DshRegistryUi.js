// DshRegistryUi.js — DSH download-source labels and failure CTAs.
// Typed error classes come from C# `DshErrorClass`. Official is upstream:
// official E404 never suggests the mirror.
