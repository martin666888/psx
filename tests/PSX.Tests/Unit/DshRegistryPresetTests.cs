...
public sealed class DshRegistryPresetTests
{
    ...
    public async Task StageUpdate_CatalogSriMismatch_RejectedBeforeCi(string registryKey)
    {
        ...
        locks.Bundle(
            "0.1.3-rc.2",
            sri: OtherSri(),
            lockJson: FakeDshLockSource.BuildLockJson("0.1.3-rc.2", DshSri.TestIntegrity));
        ...
        var result = await runtime.StageUpdateAsync(registry, "0.1.3-rc.2", CancellationToken.None);
        ...
        Assert.IsFalse(runtime.ApplyStagedUpdate("0.1.3-rc.2"));
    }
    ...
    public async Task CheckForUpdate_PartitionsInstallableDeferredAndBlocked()
    {
        ...
        SeedScriptedNpm(
            ...
            console.log(JSON.stringify({
              versions: ['0.1.3-alpha.2', '0.1.3-rc.2', '0.1.3-rc.3', '0.1.3-rc.4', '0.1.3-rc.5'],
              'dist-tags': { latest: '0.1.3-rc.5' }
            }));
            """);
    ...
    public async Task ReceiptV3_RoundTrip_AndStagedValidationUsesOfficialOriginAndLockSha()
    {
        ...
        Assert.AreEqual(
            FakeDshLockSource.HashText(FakeDshLockSource.BuildLockJson("0.1.3-rc.2", DshSri.TestIntegrity)),
            receipt.LockSha256,
            ignoreCase: true);
        ...
        File.WriteAllText(
            lockPath,
            FakeDshLockSource.BuildLockJson("0.1.3-rc.2", DshSri.TestIntegrity)
                .Replace("registry.npmjs.org", "registry.npmmirror.com", StringComparison.Ordinal));
        Assert.IsNotNull(DshWebRuntime.ValidateStagedUpdate(paths.DshNextDirectory, "0.1.3-rc.2"));
        ...
        File.WriteAllText(
            lockPath,
            FakeDshLockSource.BuildLockJson("0.1.3-rc.2", OtherSri()));
        Assert.IsNotNull(DshWebRuntime.ValidateStagedUpdate(paths.DshNextDirectory, "0.1.3-rc.2"));
    }
    ...
    public void V2MirrorTree_StillPassesStartupGate()
    {
        ...
        SeedMirrorV2UpdateTree(paths.DshCurrentDirectory, "0.1.3-rc.2");
    ...
    public void V1OfficialReceipt_StillAuthorizesLaunch()
    {
        ...
        SeedAuthorizedDshUpdateTree(locator.Locate().DshCurrentDirectory, "0.1.3-rc.2");
        Assert.IsTrue(runtime.IsInstalled());
        Assert.AreEqual("0.1.3-rc.2", runtime.CurrentVersion);
    }
    ...
    public async Task IdleRegistryChange_ClearsCatalog()
    {
        ...
        SeedScriptedNpm(
            ...
            """
            console.log(JSON.stringify({
              versions: ['0.1.3-rc.3', '0.1.3-rc.4'],
    ...
    public async Task CheckCompletion_UnrelatedRevisionBump_KeepsCatalog()
    {
        ...
        SeedScriptedNpm(
            paths,
            "console.log(JSON.stringify({ versions: ['0.1.3-rc.3'], 'dist-tags': { latest: '0.1.3-rc.3' } }));");
        var bridge = new RecordingAgentBridgeService();
