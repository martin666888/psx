...
public sealed class DshRegistryPresetTests
{
    ...
    public async Task StageUpdate_CatalogSriMismatch_RejectedBeforeCi(string registryKey)
    {
        ...
        locks.Bundle(
            "0.1.2-alpha.6",
            sri: OtherSri(),
            lockJson: FakeDshLockSource.BuildLockJson("0.1.2-alpha.6", DshSri.TestIntegrity));
        ...
        var result = await runtime.StageUpdateAsync(registry, "0.1.2-alpha.6", CancellationToken.None);
        ...
        Assert.IsFalse(runtime.ApplyStagedUpdate("0.1.2-alpha.6"));
    }
    ...
    public async Task CheckForUpdate_PartitionsInstallableDeferredAndBlocked()
    {
        ...
        SeedScriptedNpm(
            ...
            console.log(JSON.stringify({
              versions: ['0.1.2-alpha.2', '0.1.2-alpha.6', '0.1.2-alpha.7', '0.1.2-alpha.8', '0.1.2-alpha.9'],
              'dist-tags': { latest: '0.1.2-alpha.9' }
            }));
            """);
        ...
        CollectionAssert.AreEqual(
            new[] { "0.1.2-alpha.9", "0.1.2-alpha.6" },
    ...
    public async Task ReceiptV3_RoundTrip_AndStagedValidationUsesOfficialOriginAndLockSha()
    {
        ...
        Assert.AreEqual(
            FakeDshLockSource.HashText(FakeDshLockSource.BuildLockJson("0.1.2-alpha.6", DshSri.TestIntegrity)),
            receipt.LockSha256,
            ignoreCase: true);
        ...
        File.WriteAllText(
            lockPath,
            FakeDshLockSource.BuildLockJson("0.1.2-alpha.6", DshSri.TestIntegrity)
                .Replace("registry.npmjs.org", "registry.npmmirror.com", StringComparison.Ordinal));
        Assert.IsNotNull(DshWebRuntime.ValidateStagedUpdate(paths.DshNextDirectory, "0.1.2-alpha.6"));
        ...
        File.WriteAllText(
            lockPath,
            FakeDshLockSource.BuildLockJson("0.1.2-alpha.6", OtherSri()));
        Assert.IsNotNull(DshWebRuntime.ValidateStagedUpdate(paths.DshNextDirectory, "0.1.2-alpha.6"));
    }
    ...
    public void V2MirrorTree_StillPassesStartupGate()
    {
        ...
        SeedMirrorV2UpdateTree(paths.DshCurrentDirectory, "0.1.2-alpha.6");
    ...
    public void V1OfficialReceipt_StillAuthorizesLaunch()
    {
        ...
        SeedAuthorizedDshUpdateTree(locator.Locate().DshCurrentDirectory, "0.1.2-alpha.6");
        Assert.IsTrue(runtime.IsInstalled());
        Assert.AreEqual("0.1.2-alpha.6", runtime.CurrentVersion);
    }
    ...
    public async Task IdleRegistryChange_ClearsCatalog()
    {
        ...
        SeedScriptedNpm(
            ...
            """
            console.log(JSON.stringify({
              versions: ['0.1.2-alpha.7', '0.1.2-alpha.8'],
    ...
    public async Task CheckCompletion_UnrelatedRevisionBump_KeepsCatalog()
    {
        ...
        SeedScriptedNpm(
            paths,
            "console.log(JSON.stringify({ versions: ['0.1.2-alpha.7'], 'dist-tags': { latest: '0.1.2-alpha.7' } }));");
        var bridge = new RecordingAgentBridgeService();
