...
public sealed class DshRegistryPresetTests
{
    ...
    public async Task StageUpdate_CatalogSriMismatch_RejectedBeforeCi(string registryKey)
    {
        ...
        locks.Bundle(
            "0.1.0-rc.7",
            sri: OtherSri(),
            lockJson: FakeDshLockSource.BuildLockJson("0.1.0-rc.7", DshSri.TestIntegrity));
        ...
        var result = await runtime.StageUpdateAsync(registry, "0.1.0-rc.7", CancellationToken.None);
        ...
        Assert.IsFalse(runtime.ApplyStagedUpdate("0.1.0-rc.7"));
    }
    ...
    public async Task CheckForUpdate_PartitionsInstallableDeferredAndBlocked()
    {
        ...
        SeedScriptedNpm(
            ...
            console.log(JSON.stringify({
              versions: ['0.1.0-rc.6', '0.1.0-rc.7', '0.1.0-rc.8', '0.1.0-rc.9', '0.1.0-rc.10'],
              'dist-tags': { latest: '0.1.0-rc.10' }
            }));
            """);
    ...
    public async Task ReceiptV3_RoundTrip_AndStagedValidationUsesOfficialOriginAndLockSha()
    {
        ...
        Assert.AreEqual(
            FakeDshLockSource.HashText(FakeDshLockSource.BuildLockJson("0.1.0-rc.7", DshSri.TestIntegrity)),
            receipt.LockSha256,
            ignoreCase: true);
        ...
        File.WriteAllText(
            lockPath,
            FakeDshLockSource.BuildLockJson("0.1.0-rc.7", DshSri.TestIntegrity)
                .Replace("registry.npmjs.org", "registry.npmmirror.com", StringComparison.Ordinal));
        Assert.IsNotNull(DshWebRuntime.ValidateStagedUpdate(paths.DshNextDirectory, "0.1.0-rc.7"));
        ...
        File.WriteAllText(
            lockPath,
            FakeDshLockSource.BuildLockJson("0.1.0-rc.7", OtherSri()));
        Assert.IsNotNull(DshWebRuntime.ValidateStagedUpdate(paths.DshNextDirectory, "0.1.0-rc.7"));
    }
    ...
    public void V2MirrorTree_StillPassesStartupGate()
    {
        ...
        SeedMirrorV2UpdateTree(paths.DshCurrentDirectory, "0.1.0-rc.7");
    ...
    public void V1OfficialReceipt_StillAuthorizesLaunch()
    {
        ...
        SeedAuthorizedDshUpdateTree(locator.Locate().DshCurrentDirectory, "0.1.0-rc.7");
        Assert.IsTrue(runtime.IsInstalled());
        Assert.AreEqual("0.1.0-rc.7", runtime.CurrentVersion);
    }
    ...
    public async Task IdleRegistryChange_ClearsCatalog()
    {
        ...
        SeedScriptedNpm(
            ...
            """
            console.log(JSON.stringify({
              versions: ['0.1.0-rc.8', '0.1.0-rc.9'],
    ...
    public async Task CheckCompletion_UnrelatedRevisionBump_KeepsCatalog()
    {
        ...
        SeedScriptedNpm(
            paths,
            "console.log(JSON.stringify({ versions: ['0.1.0-rc.8'], 'dist-tags': { latest: '0.1.0-rc.8' } }));");
        var bridge = new RecordingAgentBridgeService();
